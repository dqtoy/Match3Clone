...
public class BoardController : Singleton<BoardController> {
    ...
    BoardObject[,] board;
    int numBoardObjectsDestroyedThisTurn;
    ...
    public void RemoveAllBoardObjects() {
    ...
    public void OnClickHandled() {
        ...
        if(numBoardObjectsDestroyedThisTurn != 0)
        {
            ScoreDisplay.Instance.DisplayScore(numBoardObjectsDestroyedThisTurn);
            numBoardObjectsDestroyedThisTurn = 0;
        }
    ...
    public void NotifyDestroyedObject(BoardObject boardObject) {
        numBoardObjectsDestroyedThisTurn++;
